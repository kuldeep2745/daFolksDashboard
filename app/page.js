...
const Page = () => {
  return (
    ...
    <Grid container spacing={2} justifyContent="center">
      ...
      <Grid item xs={12} sm={8} md={6} lg={3}>
        <BasicCard type={"people"} head={"Total People"} count={300} btnTxt={"view people"} lottie={"https://lottie.host/embed/33ce8be8-7a46-4e5a-86eb-c321b2260be7/QoAxJ1Tpcy.json"} />
      </Grid>
      <Grid item xs={12} sm={8} md={6} lg={3}>
